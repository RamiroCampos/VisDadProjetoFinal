...
main.variable(observer("viewof typeMaterial")).define("viewof typeMaterial", ["Inputs"], function(Inputs){return(
  Inputs.select(["T5_LEATHER", "T5_HIDE", "T6_LEATHER",  "T6_HIDE", "T7_LEATHER",  "T7_HIDE",], {label: "Selecione o material "})
  )});
    main.variable(observer("typeMaterial")).define("typeMaterial", ["Generators", "viewof typeMaterial"], (G, _) => G.input(_));
